...
# 6          | Correlated sources | 2 sources at -20° and 20°, SNR_1 is 15dB, SNR_2 is -15dB, AWGN, highly correlated
# 7          | Correlated noise | 2 sources at -20° and 20°, SNR_1 is 15dB, SNR_2 is -15dB, AWGN highly correlated
# 8          | Off-grid resolution | 2 sources at -23.7° and 23.3°, SNR_1 is 15dB, SNR_2 is -15dB, AWGN, 1 deg angular scan resolution
# 9          | Reduced number of samples | 20 samples instead of 100, 2 sources at -20° and 20°, SNR_1 is 15dB, SNR_2 is -15dB, AWGN
# 10         | Multipath coherency | 1 source at -20°, SNR=20dB, reflection at 20°, AWGN
# 11         | Sparse array | 2-element ULA, less spatial information, models struggle with resolution
...
# 13         | Time-varying DOAs | DOAs changing sinusoidally over time, models must handle dynamic sources
